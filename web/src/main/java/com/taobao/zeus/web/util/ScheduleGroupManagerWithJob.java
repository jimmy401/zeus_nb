 ...
 *
 */
@Repository("scheduleGroupManagerWithJob")
public class ScheduleGroupManagerWithJob implements GroupManagerWithJob{

	@Autowired
	@Qualifier("mysqlGroupManagerWithJob")
	GroupManagerWithJob groupManager;

	private static Logger log=LogManager.getLogger(ScheduleGroupManagerWithJob.class);
